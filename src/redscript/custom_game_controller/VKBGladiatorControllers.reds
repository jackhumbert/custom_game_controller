...
public class CustomGameController_231D_0200 extends ICustomGameController {
  public func OnSetup() -> Void {
    ...
    this.SetAxis(1 - 1, EInputKey.IK_JoyX, false, 0.5, 0.001);
    this.SetAxis(2 - 1, EInputKey.IK_JoyY, true, 0.5, 0.001);
    this.SetAxis(4 - 1, EInputKey.IK_Pad_RightAxisX, false, 0.5, 0.001);
    this.SetAxis(5 - 1, EInputKey.IK_Pad_RightAxisY, false, 0.5, 0.001);
    this.SetAxis(6 - 1, EInputKey.IK_JoyZ, false, 0.5, 0.001);
    this.SetAxis(7 - 1, EInputKey.IK_JoySlider1, false, 0.5, 0.001);
    this.SetAxis(8 - 1, EInputKey.IK_JoySlider2, false, 0.5, 0.001);
  }
}
...
public class CustomGameController_231D_0201 extends ICustomGameController {
  public func OnSetup() -> Void {
    ...
    this.SetButton(21 - 1, EInputKey.IK_Joy5);
    this.SetButton(22 - 1, EInputKey.IK_Pad_LeftShoulder);

    this.SetAxis(1 - 1, EInputKey.IK_JoyU, false, 0.5, 0.001);
    this.SetAxis(2 - 1, EInputKey.IK_JoyV, true, 0.5, 0.001);
    this.SetAxis(4 - 1, EInputKey.IK_Pad_LeftAxisX, false, 0.5, 0.001);
    this.SetAxis(5 - 1, EInputKey.IK_Pad_LeftAxisY, false, 0.5, 0.001);
    this.SetAxis(6 - 1, EInputKey.IK_JoyR, false, 0.5, 0.001);
  }
}