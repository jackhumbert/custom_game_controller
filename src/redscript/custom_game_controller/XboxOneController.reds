...
// newer Xbox One controller
public class CustomGameController_045E_0B12 extends ICustomGameController {
  public func OnSetup() -> Void {
    this.SetButton(1  - 1, EInputKey.IK_Pad_A_CROSS);
    this.SetButton(2  - 1, EInputKey.IK_Pad_B_CIRCLE);
    this.SetButton(3  - 1, EInputKey.IK_Pad_X_SQUARE);
...
// bluetooth
public class CustomGameController_045E_0B13 extends ICustomGameController {
  public func OnSetup() -> Void {
    this.SetButton(1  - 1, EInputKey.IK_Pad_A_CROSS);
    this.SetButton(2  - 1, EInputKey.IK_Pad_B_CIRCLE);
    this.SetButton(3  - 1, EInputKey.IK_Pad_X_SQUARE);
